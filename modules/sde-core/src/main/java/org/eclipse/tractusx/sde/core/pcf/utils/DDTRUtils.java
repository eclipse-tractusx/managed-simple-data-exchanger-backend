...
public class DDTRUtils {
	...
	public List<QueryDataOfferModel> getdDTRUrlFromTwin(String bpnNumber) {
	...
	public EDRCachedByIdResponse verifyAndGetToken(String bpnNumber, QueryDataOfferModel queryDataOfferModel) {
		...
		Offer offer = Offer.builder()
				.assetId(queryDataOfferModel.getAssetId())
