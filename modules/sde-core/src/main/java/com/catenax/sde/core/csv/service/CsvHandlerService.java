...
package com.catenax.sde.core.csv.service;
...
import com.catenax.sde.common.exception.CsvException;
import com.catenax.sde.core.cvs.entities.CsvContent;
import com.catenax.sde.core.cvs.entities.RowData;
    ...
    public String storeFile(MultipartFile multipartFile) {
        ...
        try {
            ...
            if (!fileName.endsWith(CSV_FILE_EXTENSION)) {
                throw new CsvException("Unsupported multipartFile. DFT only supports .csv files");
            }
