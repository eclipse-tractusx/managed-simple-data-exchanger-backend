...
import com.catenax.sde.controllers.AspectController;
...
import com.catenax.sde.entities.aspect.*;
import com.catenax.sde.entities.aspectrelationship.AspectRelationshipRequest;
...
import com.catenax.sde.usecases.csvhandler.aspectrelationship.CreateAspectRelationshipUseCase;
import com.catenax.sde.usecases.csvhandler.aspects.CreateAspectsUseCase;
...
class AspectControllerTest {
    ...
    private SubmodelJsonRequest<AspectRequest> getAspectRequest() {
        ...
        UsagePolicy UsagePolicy = com.catenax.sde.edc.entities.UsagePolicy.builder()
