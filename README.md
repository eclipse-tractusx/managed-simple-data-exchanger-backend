...
https://github.com/catenax-ng/tx-managed-simple-data-exchanger-backend/blob/main/modules/sde-core/src/main/resources/sde-open-api.yml
Backend API Swagger-ui : https://<host-url>/backend/api/swagger-ui/index.html
---
#### **Response Status**
---
