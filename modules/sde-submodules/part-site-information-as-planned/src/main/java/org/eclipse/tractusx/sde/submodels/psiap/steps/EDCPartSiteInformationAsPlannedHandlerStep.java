...
public class EDCPartSiteInformationAsPlannedHandlerStep extends Step {
	...
	public EDCPartSiteInformationAsPlannedHandlerStep(EDCGateway edcGateway, AssetEntryRequestFactory assetFactory,
			PolicyRequestFactory policyFactory, ContractDefinitionRequestFactory contractFactory,
			PolicyConstraintBuilderService policyConstraintBuilderService, PartSiteInformationAsPlannedService partSiteInformationAsPlannedService) {
		this.assetFactory = assetFactory;
		this.edcGateway = edcGateway;
		this.policyFactory = policyFactory;
		this.contractFactory = contractFactory;
		this.policyConstraintBuilderService = policyConstraintBuilderService;
		this.partSiteInformationAsPlannedService = partSiteInformationAsPlannedService;
	}
	...
	private void deleteEDCFirstForUpdate(String submodel, PartSiteInformationAsPlanned input, String processId) {
		try {
			PartSiteInformationAsPlannedEntity partSiteInformationAsPlannedEntity = partSiteInformationAsPlannedService.readEntity(input.getUuid());
	...
	private String getCustomValue(PartSiteInformationAsPlanned input) {
