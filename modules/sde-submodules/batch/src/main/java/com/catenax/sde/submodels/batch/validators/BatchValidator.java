...
package com.catenax.sde.submodels.batch.validators;
...
public class BatchValidator implements ConstraintValidator<BatchValidation, Batch> {
    @Override
    public void initialize(BatchValidation constraintAnnotation) {
